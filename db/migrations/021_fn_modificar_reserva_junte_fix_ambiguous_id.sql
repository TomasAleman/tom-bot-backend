-- =====================================================================
-- Migration 021: fn_modificar_reserva_junte — id ambiguo
-- =====================================================================
-- RETURNS TABLE(...) en PL/pgSQL define variables OUTPUT con los mismos
-- nombres que las columnas. En 020, `WHERE id = p_reserva_id` al cargar
-- la reserva chocaba con la variable `id` del retorno → ERROR 42702
-- al hacer PATCH /api/reservas/:id con junte (mesas[]).
