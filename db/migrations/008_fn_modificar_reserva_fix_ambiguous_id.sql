-- =====================================================================
-- Migration 008: fn_modificar_reserva — restaurante_id ambiguo
-- =====================================================================
-- RETURNS TABLE(...) en PL/pgSQL crea variables OUTPUT con los mismos
-- nombres que las columnas. El bloque PERFORM ... FROM mesas WHERE
-- restaurante_id = ... era ambiguo (variable vs columna) y fallaba
-- con ERROR; n8n (continueOnFail) devolvia 0 filas y el flujo mostraba
-- "sin disponibilidad" aunque hubiera mesa libre.
-- Idempotente: CREATE OR REPLACE igual que 007 ya corregido.
-- =====================================================================
